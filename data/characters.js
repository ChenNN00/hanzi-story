...
const SOURCES = [
  ...
  { title: '字源 (hanziyuan.net)', desc: '汉字字形演变可视化档案' }
    '的': {
      pinyin: 'de', translation: 'of, possessive particle', stroke_count: 8, hsk_level: 1, radical: '白',
      category: 'other', illustration: 'target',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
        modern: '(source TBD)',
        origin: '(source TBD)'
      },
      story: {
        title: '的',
        title_en: 'of',
        content: 'A common character in everyday Chinese writing.'
      },
      example_sentences: [{ chinese: '我的你', pinyin: 'wǒ de nǐ', english: 'I de you' }],
      related_characters: []
    },
    '是': {
      pinyin: 'shì', translation: 'am, is, are (to be)', stroke_count: 9, hsk_level: 1, radical: '日',
      category: 'other', illustration: 'target',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我是你', pinyin: 'wǒ shì nǐ', english: 'I shì you' }],
      related_characters: []
    },
    '不': {
      pinyin: 'bù', translation: 'not, no', stroke_count: 4, hsk_level: 1, radical: '一',
      category: 'other', illustration: 'cross',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我不你', pinyin: 'wǒ bù nǐ', english: 'I bù you' }],
      related_characters: []
    },
    '了': {
      pinyin: 'le', translation: 'completed action particle', stroke_count: 2, hsk_level: 1, radical: '亅',
      category: 'other', illustration: 'tree',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      story: {
        title: '了',
        title_en: 'completed action particle',
        content: 'A common character in everyday Chinese writing.'
      },
      example_sentences: [{ chinese: '我了你', pinyin: 'wǒ le nǐ', english: 'I le you' }],
      related_characters: []
    },
    '在': {
      pinyin: 'zài', translation: 'at, in, on (location)', stroke_count: 6, hsk_level: 1, radical: '土',
      category: 'people', illustration: 'field',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我在你', pinyin: 'wǒ zài nǐ', english: 'I zài you' }],
      related_characters: []
    },
    '有': {
      pinyin: 'yǒu', translation: 'have, there is', stroke_count: 6, hsk_level: 1, radical: '八',
      category: 'people', illustration: 'cross',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我有你', pinyin: 'wǒ yǒu nǐ', english: 'I yǒu you' }],
      related_characters: []
    },
    '我': {
      pinyin: 'wǒ', translation: 'I, me', stroke_count: 7, hsk_level: 1, radical: '戈',
      category: 'people', illustration: 'tree',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我我你', pinyin: 'wǒ wǒ nǐ', english: 'I wǒ you' }],
      related_characters: []
    },
    '你': {
      pinyin: 'nǐ', translation: 'you', stroke_count: 7, hsk_level: 1, radical: '亻',
      ...
      example_sentences: [{ chinese: '我你你', pinyin: 'wǒ nǐ nǐ', english: 'I nǐ you' }],
      related_characters: []
    },
    '他': {
      pinyin: 'tā', translation: 'he, him', stroke_count: 5, hsk_level: 1, radical: '亻',
      category: 'people', illustration: 'person',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我他你', pinyin: 'wǒ tā nǐ', english: 'I tā you' }],
      related_characters: []
    },
    '她': {
      pinyin: 'tā', translation: 'she, her', stroke_count: 5, hsk_level: 1, radical: '女',
      ...
      example_sentences: [{ chinese: '我她你', pinyin: 'wǒ tā nǐ', english: 'I tā you' }],
      related_characters: []
    },
    '这': {
      pinyin: 'zhè', translation: 'this', stroke_count: 7, hsk_level: 1, radical: '辶',
      category: 'people', illustration: 'tree',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我这你', pinyin: 'wǒ zhè nǐ', english: 'I zhè you' }],
      related_characters: []
    },
    '那': {
      pinyin: 'nà', translation: 'that', stroke_count: 6, hsk_level: 1, radical: '阝',
      category: 'people', illustration: 'field',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我那你', pinyin: 'wǒ nà nǐ', english: 'I nà you' }],
      related_characters: []
    },
    '们': {
      pinyin: 'men', translation: 'plural marker', stroke_count: 5, hsk_level: 1, radical: '亻',
      category: 'people', illustration: 'person',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      story: {
        title: '们',
        title_en: 'plural marker',
        content: 'A common character in everyday Chinese writing.'
      },
      example_sentences: [{ chinese: '我们你', pinyin: 'wǒ men nǐ', english: 'I men you' }],
      related_characters: []
    },
    '来': {
      pinyin: 'lái', translation: 'come, arrive', stroke_count: 7, hsk_level: 1, radical: '木',
      category: 'people', illustration: 'tree',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我来你', pinyin: 'wǒ lái nǐ', english: 'I lái you' }],
      related_characters: []
    },
    '去': {
      pinyin: 'qù', translation: 'go, leave', stroke_count: 5, hsk_level: 1, radical: '土',
      category: 'people', illustration: 'person',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我去你', pinyin: 'wǒ qù nǐ', english: 'I qù you' }],
      related_characters: []
    },
    '吃': {
      pinyin: 'chī', translation: 'eat', stroke_count: 6, hsk_level: 1, radical: '口',
      ...
      example_sentences: [{ chinese: '我吃你', pinyin: 'wǒ chī nǐ', english: 'I chī you' }],
      related_characters: []
    },
    '说': {
      pinyin: 'shuō', translation: 'speak, say', stroke_count: 9, hsk_level: 1, radical: '讠',
      category: 'people', illustration: 'mouth',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我说你', pinyin: 'wǒ shuō nǐ', english: 'I shuō you' }],
      related_characters: []
    },
    '学': {
      pinyin: 'xué', translation: 'learn, study', stroke_count: 8, hsk_level: 1, radical: '子',
      ...
      example_sentences: [{ chinese: '我学你', pinyin: 'wǒ xué nǐ', english: 'I xué you' }],
      related_characters: []
    },
    '好': {
      pinyin: 'hǎo', translation: 'good, well', stroke_count: 6, hsk_level: 1, radical: '女',
      category: 'people', illustration: 'woman',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我好你', pinyin: 'wǒ hǎo nǐ', english: 'I hǎo you' }],
      related_characters: []
    },
    '多': {
      pinyin: 'duō', translation: 'many, much', stroke_count: 6, hsk_level: 1, radical: '夕',
      category: 'numbers', illustration: 'moon',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我多你', pinyin: 'wǒ duō nǐ', english: 'I duō you' }],
      related_characters: []
    },
    '上': {
      pinyin: 'shàng', translation: 'up, above', stroke_count: 3, hsk_level: 1, radical: '一',
      category: 'numbers', illustration: 'target',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我上你', pinyin: 'wǒ shàng nǐ', english: 'I shàng you' }],
      related_characters: []
    },
    '里': {
      pinyin: 'lǐ', translation: 'inside, within', stroke_count: 7, hsk_level: 1, radical: '田',
      category: 'numbers', illustration: 'field',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
        seal_script: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我里你', pinyin: 'wǒ lǐ nǐ', english: 'I lǐ you' }],
      related_characters: []
    },
    '国': {
      pinyin: 'guó', translation: 'country, nation', stroke_count: 8, hsk_level: 1, radical: '囗',
      category: 'numbers', illustration: 'field',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我国你', pinyin: 'wǒ guó nǐ', english: 'I guó you' }],
      related_characters: []
    },
    '家': {
      pinyin: 'jiā', translation: 'home, family', stroke_count: 10, hsk_level: 1, radical: '宀',
      category: 'people', illustration: 'tree',
      etymology: {
        oracle_bone: '(source TBD)',
        bronze: '(source TBD)',
      ...
      example_sentences: [{ chinese: '我家你', pinyin: 'wǒ jiā nǐ', english: 'I jiā you' }],
      related_characters: []
    },
    '林': {
      pinyin: 'lín', translation: 'forest, woods', stroke_count: 8, hsk_level: 2, radical: '木',
      category: 'nature', illustration: 'tree',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'lín = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '林',
        title_en: 'forest',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['木', '木'], meaning: 'two trees together form a forest' }
      },
      example_sentences: [{ chinese: '林这个字', pinyin: 'lín zhège zì', english: 'this character lín' }],
      related_characters: []
    },
    '休': {
      pinyin: 'xiū', translation: 'rest, stop', stroke_count: 6, hsk_level: 2, radical: '亻',
      category: 'people', illustration: 'person',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'xiū = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '休',
        title_en: 'rest',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['亻', '木'], meaning: 'a person leaning against a tree, resting' }
      },
      example_sentences: [{ chinese: '休这个字', pinyin: 'xiū zhège zì', english: 'this character xiū' }],
      related_characters: []
    },
    '明': {
      pinyin: 'míng', translation: 'bright, clear', stroke_count: 8, hsk_level: 1, radical: '日',
      category: 'nature', illustration: 'sun',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'míng = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '明',
        title_en: 'bright',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['日', '月'], meaning: 'sun and moon together = brightness' }
      },
      example_sentences: [{ chinese: '明这个字', pinyin: 'míng zhège zì', english: 'this character míng' }],
      related_characters: []
    },
    '妈': {
      pinyin: 'mā', translation: 'mother, mom', stroke_count: 6, hsk_level: 1, radical: '女',
      category: 'people', illustration: 'woman',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'mā = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '妈',
        title_en: 'mother',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['女', '马'], meaning: 'woman with a horse = mother (ancient phonetic)' }
      },
      example_sentences: [{ chinese: '妈这个字', pinyin: 'mā zhège zì', english: 'this character mā' }],
      related_characters: []
    },
    '想': {
      pinyin: 'xiǎng', translation: 'think, miss', stroke_count: 13, hsk_level: 2, radical: '心',
      category: 'people', illustration: 'heart',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'xiǎng = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '想',
        title_en: 'think',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['相', '心'], meaning: 'mutual observation + heart = to think' }
      },
      example_sentences: [{ chinese: '想这个字', pinyin: 'xiǎng zhège zì', english: 'this character xiǎng' }],
      related_characters: []
    },
    '妙': {
      pinyin: 'miào', translation: 'wonderful, subtle', stroke_count: 7, hsk_level: 2, radical: '女',
      category: 'people', illustration: 'woman',
      etymology: {
        oracle_bone: '(see separate entries for components)',
        bronze: '(see separate entries for components)',
        seal_script: '(see separate entries for components)',
        modern: 'miào = a compound character built from two components',
        origin: 'composed character: ' + meaning'
      },
      story: {
        title: '妙',
        title_en: 'wonderful',
        content: 'A compound character built from simpler parts. (Content TBD)',
        compound: { from: ['女', '少'], meaning: 'woman + few/small = wonderful, refined' }
      },
      example_sentences: [{ chinese: '妙这个字', pinyin: 'miào zhège zì', english: 'this character miào' }],
      related_characters: []
    },
];
